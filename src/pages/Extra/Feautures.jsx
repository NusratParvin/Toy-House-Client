...
const Feautures = () => {
    return (
        <div>
            <div class="w-4/5 my-12 pt-6 px-6 mx-auto">

                <section class="mb-12 text-gray-800 text-center">
                    <div class="flex justify-center">
                        <div class="text-center max-w-[700px]">
                            <h2 class="text-3xl font-bold mb-6 text-center text-teal-700">
                                Why is it so<u class="text-orange-600"> fun?</u>
                            </h2>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
                        <div class="mb-12 lg:mb-0">
                            <div class="p-4 bg-teal-600 rounded-full shadow-lg inline-block mb-6">
                        ...
                        <div class="mb-12 md:mb-0">
                            ...
                            <h5 class="text-lg font-bold mb-4">Always in Stock</h5>
                            <p class="text-gray-500">
